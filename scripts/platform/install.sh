...
# Usage: curl -sSL https://raw.githubusercontent.com/mnemox-ai/tradememory-protocol/master/scripts/platform/install.sh | bash
# Or:    bash install.sh
...
echo "    python -m tradememory  # Start MCP server"
echo ""
